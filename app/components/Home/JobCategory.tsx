    ...
    <div className='pt-20 pb-12'>
       <Heading mainHeading="Popular job Categories" subHeading="2024 jobs live - 293 added today."/>
         <div className='w-[80%] mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[4rem] gap-[3rem] items-center'>
            ...
            <JobCategoryCard image='/images/icon4.png' category='Dvelopment' openPosition="23" />
            <JobCategoryCard image='/images/icon5.png' category='Human Resource' openPosition="33" />
            <JobCategoryCard image='/images/icon6.png' category='Automotive Jobs' openPosition="53" />
            <JobCategoryCard image='/images/icon7.png' category='Customer Services' openPosition="13" />
            <JobCategoryCard image='/images/icon8.png' category='Health and Care' openPosition="03" />
